...
ggplot(variog_rain_precip) + 
  ...
  ggtitle("Humberto-2007 Variogram -- Precipitation") + theme(legend.position = "none")
# variogram of percip_max
...
ggplot(variog_rain_precip_max) + 
  ...
  ggtitle("Humberto-2007 Variogram -- Max Precipitation") + theme(legend.position = "none")
```
```{r}
...
ggplot(variog_wind_gust) + 
  geom_point(aes(x = dist, y = gamma, color = dist)) + 
  geom_line(data = line_wind_gust, aes(x = dist, y = gamma), color = "red") + 
  ggtitle("Humberto-2007 Variogram -- Gust wind") + theme(legend.position = "none")
...
ggplot(variog_wind_sust) + 
  geom_point(aes(x = dist, y = gamma, color = dist)) + 
  geom_line(data = line_wind_sust, aes(x = dist, y = gamma), color = "red") + 
  ggtitle("Humberto-2007 Variogram -- sustained wind") + theme(legend.position = "none")
...
ggplot(variog_wind_gust_dur) + 
  geom_point(aes(x = dist, y = gamma, color = dist)) + 
  geom_line(data = line_wind_gust_dur, aes(x = dist, y = gamma), color = "red") + 
  ggtitle("Humberto-2007 Variogram -- gust wind duration") + theme(legend.position = "none")
...
ggplot(variog_wind_sust_dur) + 
  geom_point(aes(x = dist, y = gamma, color = dist)) + 
  geom_line(data = line_wind_sust_dur, aes(x = dist, y = gamma), color = "red") + 
  ggtitle("Humberto-2007 Variogram -- sustained wind duration") + theme(legend.position = "none")
